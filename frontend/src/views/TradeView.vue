    ...
    <template v-if="userStore.isLoggedIn()">
      ...
      <div class="card" style="padding: 2px 14px;">
        <div v-for="p in sim.positions" :key="p.stockId" class="pos"
          @click="claimStockPrefetch(p.code); cancelOtherPrefetches(p.code); $router.push(`/stock/${p.code}`)">
          <div class="phead">
            <div>
...
import { cancelOtherPrefetches, claimStockPrefetch } from '@/utils/detailPrefetch'
